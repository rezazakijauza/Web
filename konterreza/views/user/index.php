  ...
  <body>
    ...
    $(document).ready(function() {
        ...
        $('#sample_form').on('submit', function(event){
            ...
            if($('#action').val() == "Add"){
                ...
                $.ajax({
                    url:"http://localhost:81/konterreza/api/user/create.php",
                    method:"POST",
                ...
                $.ajax({
                    url:"http://localhost:81/konterreza/api/user/update.php",
                    method:"PUT",
                    data: JSON.stringify(formData),
                    success:function(data){
                        $('#action_button').attr('disabled', false);
    ...
    function showAll() {
        $.ajax({
            ...
            url:"http://localhost:81/konterreza/api/user/read.php",
    ...
    function showOne(id) {
        ...
        $.ajax({
            ...
            contentType: "application/json",
            url:
            "http://localhost:81/konterreza/api/user/read.php?id="+id,
            success: function(response) {
                $('#id').val(response.id);
    ...
    function deleteOne(id) {
        ...
        $.ajax({
            url:"http://localhost:81/konterreza/api/user/delete.php",
            method:"DELETE",
